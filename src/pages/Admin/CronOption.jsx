			...
			<Row className="g-3">
				...
				<Col xs={12}>
					<Card>
						...
						<Card.Body className="pt-0 px-4 pb-4">curl -s https://testserver.Upwork.net/cron/alert-user/after/order/expired</Card.Body>
					</Card>
				</Col>
				<Col xs={12}>
					<Card>
						...
						<Card.Body className="pt-0 px-4 pb-4">curl -s https://testserver.Upwork.net/cron/alert-user/before/order/expired</Card.Body>
					</Card>
				</Col>
			</Row>
		</>
